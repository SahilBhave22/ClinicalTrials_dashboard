...
-- Generated by scripts/generate_snapshot_sql.py on 2026-04-28 14:53 UTC
--
-- HOW TO USE:
...
SELECT
    ...
    '2026-04-28 14:53:08+00'::timestamptz
...
WHERE scope_key NOT IN ('global', 'ind:breast neoplasms|lung neoplasms', 'ind:dermatitis, atopic|migraine disorders|pulmonary disease, chronic obstructive');
